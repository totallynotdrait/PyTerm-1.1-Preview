...
#needed modules
import os, socket, shutil, sys, datetime, platform, subprocess, configparser, logging, json, itertools, threading, pathlib, winsound
...
def pyterm():
    ...
    while True:
        try:
            ...
            prRed("Trying to Install required module: playsound\n")
...
sys                                                  Contains important files to make PyTerm working
...
Thanks for using PyTerm, if you're having problems with PyTerm, view PyTerm GitHub repository
        ...
        #disactivate bootlog
            ...
            if currentdir == "sys":
                ...
                prRed("you're not in the 'sys' folder")
